...
( function( $ ) {
	...
	wp.customize( 'top_header_bg_color', function( value ) {
		value.bind( function( to ) {
			var top_header_bg_color = '.top-header-section{ background:'+ to +'; }';
	...
	wp.customize( 'menu_bg_color', function( value ) {
		value.bind( function( to ) {
			var menu_bg_color = '#header-navigation ul{ background:'+ to +'!important; }';
	...
	wp.customize( 'menu_link_color', function( value ) {
		value.bind( function( to ) {
			var menu_link_color = '#header-navigation ul li a, .shortlist-align a{ color:'+ to +'!important; }';
	...
	wp.customize( 'menu_link_icon_color', function( value ) {
		value.bind( function( to ) {
			var menu_link_icon_color = '.menu > ul > li.fa:before{ color:'+ to +'!important; }';
	...
	wp.customize( 'menu_link_hover_color', function( value ) {
		value.bind( function( to ) {
			var menu_link_hover_color = '#header-navigation ul li a:hover, .shortlist-align a:hover{ color:'+ to +'!important; }';
	...
	wp.customize( 'menu_link_icon_hover_color', function( value ) {
		value.bind( function( to ) {
			var menu_link_icon_hover_color = '#header-navigation ul li:hover:before{ color:'+ to +'!important; }';
	...
	wp.customize( 'menu_hover_border_color', function( value ) {
		value.bind( function( to ) {
			var menu_hover_border_color = '	#header-navigation ul li a:hover{ color:'+ to +'!important; }';
	...
	wp.customize( 'menu_link_left_border_color', function( value ) {
		value.bind( function( to ) {
			var menu_link_left_border_color = '#main-nav ul#main-menu > li a{ border-left:1px solid '+ to +'!important; }';
	...
	wp.customize( 'menu_link_right_border_color', function( value ) {
		value.bind( function( to ) {
			var menu_link_left_border_color = '#main-nav ul#main-menu > li a{ border-right:1px solid '+ to +'!important; }';
	...
	wp.customize( 'menu_active_link_bg_color', function( value ) {
		value.bind( function( to ) {
			var menu_active_link_bg_color = '#header-navigation ul li.current-menu-item.current_page_item a{ background:'+ to +'!important; }';
	...
	wp.customize( 'menu_active_link_icon_color', function( value ) {
		value.bind( function( to ) {
			var menu_active_link_icon_color = '#header-navigation ul li.current-menu-item.current_page_item:before{ color:'+ to +'!important; }';
	...
	wp.customize( 'menu_active_border_color', function( value ) {
		value.bind( function( to ) {
			var menu_active_border_color = '#header-navigation ul li.current-menu-item.current_page_item > a{ color:'+ to +'!important; }';
	...
	wp.customize( 'child_menu_active_link_color', function( value ) {
		value.bind( function( to ) {
			var child_menu_active_link_color = '#header-navigation ul ul li.current-menu-item a{ color:'+ to +'!important; }';
	...
	wp.customize( 'child_menu_border_bottom_color', function( value ) {
		value.bind( function( to ) {
			var child_menu_border_bottom_color = '#header-navigation ul ul li a{ border-bottom:1px solid '+ to +'!important; }';
	...
	wp.customize( 'search_toggle_bar_BG_color', function( value ) {
		value.bind( function( to ) {
			var search_toggle_bar_BG_color = '.toggle_search_icon{ border-top:50px solid '+ to +'!important; }';
			if( $(document).find('#search_toggle_bar_BG_color').length ){
				$(document).find('#search_toggle_bar_BG_color').remove();
			}
			$(document).find('head').append($('<style id=search_toggle_bar_BG_color>' + search_toggle_bar_BG_color + '</style>'));
		} );
	} );
	wp.customize( 'search_toggle_bar_icon_color', function( value ) {
		value.bind( function( to ) {
			var search_toggle_bar_icon_color = '.toggle_search_icon i{ color:'+ to +'!important; }';
			if( $(document).find('#search_toggle_bar_icon_color').length ){
				$(document).find('#search_toggle_bar_icon_color').remove();
			}
			$(document).find('head').append($('<style id=search_toggle_bar_icon_color>' + search_toggle_bar_icon_color + '</style>'));
		} );
	} );
	...
	wp.customize( 'shortlist_tab_BG_color', function( value ) {
		value.bind( function( to ) {
			var shortlist_tab_BG_color = '.cpt_posts_add_remove{ background: '+ to +'!important; }';
	...
	wp.customize( 'shortlist_tab_border_color', function( value ) {
		value.bind( function( to ) {
			var shortlist_tab_border_color = '.cpt_posts_add_remove{ border:1px solid '+ to +'!important; }';
			if( $(document).find('#shortlist_tab_border_color').length ){
				$(document).find('#shortlist_tab_border_color').remove();
			}
			$(document).find('head').append($('<style id=shortlist_tab_border_color>' + shortlist_tab_border_color + '</style>'));
		} );
	} );

	wp.customize( 'compcard_tab_BG_color', function( value ) {
		value.bind( function( to ) {
			var compcard_tab_BG_color = '.pods_cpt_single_compcard a{ background: '+ to +'!important; }';
			if( $(document).find('#compcard_tab_BG_color').length ){
				$(document).find('#compcard_tab_BG_color').remove();
			}
			$(document).find('head').append($('<style id=compcard_tab_BG_color>' + compcard_tab_BG_color + '</style>'));
		} );
	} );

	wp.customize( 'compcard_tab_color', function( value ) {
		value.bind( function( to ) {
			var compcard_tab_color = '.pods_cpt_single_compcard a{ color: '+ to +'!important; }';
			if( $(document).find('#compcard_tab_color').length ){
				$(document).find('#compcard_tab_color').remove();
			}
			$(document).find('head').append($('<style id=compcard_tab_color>' + compcard_tab_color + '</style>'));
		} );
	} );

	wp.customize( 'compcard_tab_border_color', function( value ) {
		value.bind( function( to ) {
			var compcard_tab_border_color = '.pods_cpt_single_compcard a{ border:1px solid '+ to +'!important; }';
			if( $(document).find('#compcard_tab_border_color').length ){
				$(document).find('#compcard_tab_border_color').remove();
			}
			$(document).find('head').append($('<style id=compcard_tab_border_color>' + compcard_tab_border_color + '</style>'));
		} );
	} );

	//Talent Post Title Section
	wp.customize( 'post_title_color', function( value ) {
		value.bind( function( to ) {
			var post_title_color = '.post-content-wrapper .grid-view-container h3, .post-content-wrapper .grid-view-container h3:before, .grid-view-container h3{ color: '+ to +'!important; }';
			if( $(document).find('#post_title_color').length ){
				$(document).find('#post_title_color').remove();
			}
			$(document).find('head').append($('<style id=post_title_color>' + post_title_color + '</style>'));
		} );
	} );

	wp.customize( 'post_title_hover_color', function( value ) {
		value.bind( function( to ) {
			var post_title_hover_color = '.post-content-wrapper h3:hover, .grid-view-container a:hover h3:before, .grid-view-container:hover h3{ color: '+ to +'!important; }';
			if( $(document).find('#post_title_hover_color').length ){
				$(document).find('#post_title_hover_color').remove();
			}
			$(document).find('head').append($('<style id=post_title_hover_color>' + post_title_hover_color + '</style>'));
		} );
	} );

	wp.customize( 'post_meta_fields_text_hover_color', function( value ) {
		value.bind( function( to ) {
			var post_meta_fields_text_hover_color = '.post-content-wrapper .title-meta-data-wrapper .general-meta-fields-info-wrapper .post-meta-general-info span{ color: '+ to +'!important; }';
			if( $(document).find('#post_meta_fields_text_hover_color').length ){
				$(document).find('#post_meta_fields_text_hover_color').remove();
			}
			$(document).find('head').append($('<style id=post_meta_fields_text_hover_color>' + post_meta_fields_text_hover_color + '</style>'));
		} );
	} );

	wp.customize( 'post_meta_fields_text_hover_BG_color', function( value ) {
		value.bind( function( to ) {
			var post_meta_fields_text_hover_BG_color = '.post-content-wrapper .grid-view-container .grid-view-image .title-meta-data-wrapper{ background: '+ to +'!important; }';
			if( $(document).find('#post_meta_fields_text_hover_BG_color').length ){
				$(document).find('#post_meta_fields_text_hover_BG_color').remove();
			}
			$(document).find('head').append($('<style id=post_meta_fields_text_hover_BG_color>' + post_meta_fields_text_hover_BG_color + '</style>'));
		} );
	} );

	wp.customize( 'single_page_post_title_color', function( value ) {
		value.bind( function( to ) {
			var single_page_post_title_color = '.post_single_page_img_details h2{ color: '+ to +'!important; }';
			if( $(document).find('#single_page_post_title_color').length ){
				$(document).find('#single_page_post_title_color').remove();
			}
			$(document).find('head').append($('<style id=single_page_post_title_color>' + single_page_post_title_color + '</style>'));
		} );
	} );

	wp.customize( 'single_page_category_link_color', function( value ) {
		value.bind( function( to ) {
			var single_page_category_link_color = '.post_single_page_img_details .one_fourth h4 a, .post_single_page_img_details .one_fourth h4{ color: '+ to +'!important; }';
			if( $(document).find('#single_page_category_link_color').length ){
				$(document).find('#single_page_category_link_color').remove();
			}
			$(document).find('head').append($('<style id=single_page_category_link_color>' + single_page_category_link_color + '</style>'));
		} );
	} );
	...
	wp.customize( 'page_titlebar_color', function( value ) {
		value.bind( function( to ) {
			var page_titlebar_color = '.kaya-page-titlebar-wrapper .page-title{ color:'+ to +'!important; }';
	...
	wp.customize( 'page_mid_contant_links_color', function( value ) {
		value.bind( function( to ) {
			var page_mid_contant_links_color = 'body a, .post_single_page_img_details .one_fourth h4 a{ color:'+ to +'!important; }';
	...
	wp.customize( 'sidebar_default_search_btn_color', function( value ) {
		value.bind( function( to ) {
			var sidebar_default_search_btn_color = 'button, input[type="button"], input[type="reset"], input[type="submit"]{ color:'+ to +'!important; }';
			if( $(document).find('#sidebar_default_search_btn_color').length ){
				$(document).find('#sidebar_default_search_btn_color').remove();
			}
			$(document).find('head').append($('<style id=sidebar_default_search_btn_color>' + sidebar_default_search_btn_color + '</style>'));
		} );
	} );

	wp.customize( 'sidebar_default_search_btn_BG_color', function( value ) {
		value.bind( function( to ) {
			var sidebar_default_search_btn_BG_color = 'button, input[type="button"], input[type="reset"], input[type="submit"]{ background:'+ to +'!important; }';
			if( $(document).find('#sidebar_default_search_btn_BG_color').length ){
				$(document).find('#sidebar_default_search_btn_BG_color').remove();
			}
			$(document).find('head').append($('<style id=sidebar_default_search_btn_BG_color>' + sidebar_default_search_btn_BG_color + '</style>'));
		} );
	} );
	...
	wp.customize( 'sidebar_tagcloud_hover_border_color', function( value ) {
		value.bind( function( to ) {
			var sidebar_tagcloud_hover_border_color = '.tagcloud a:hover{ border-right:3px solid '+ to +'; }';
...
wp.customize( 'page_footer_bg_color', function( value ) {
	...
	wp.customize('body_font_size', function(  value ){
		value.bind(function(to){
			...
			var body_font_size = 'body, p{ font-size:'+ to +'px!important;}';
	...
	wp.customize('h1_title_fontsize', function(  value ){
		value.bind(function(to){
			...
			var h1_title_fontsize = 'h1{ font-size:'+ to +'px!important;}';
	...
	wp.customize('h2_title_fontsize', function(  value ){
		value.bind(function(to){
			...
			var h2_title_fontsize = 'h2{ font-size:'+ to +'px!important;}';
	...
	wp.customize('h3_title_fontsize', function(  value ){
		value.bind(function(to){
			...
			var h3_title_fontsize = 'h3, .grid-view-container h3:before{ font-size:'+ to +'px!important;}';
	...
	wp.customize('h4_title_fontsize', function(  value ){
		value.bind(function(to){
			...
			var h4_title_fontsize = 'h4{ font-size:'+ to +'px!important;}';
	...
	wp.customize('h5_title_fontsize', function(  value ){
		value.bind(function(to){
			...
			var h5_title_fontsize = 'h5{ font-size:'+ to +'px!important;}';
	...
	wp.customize('h6_title_fontsize', function(  value ){
		value.bind(function(to){
			...
			var h6_title_fontsize = 'h6{ font-size:'+ to +'px!important;}';
	...
	wp.customize('menu_font_letter_space', function(  value ){
		value.bind(function(to){
			var menu_font_letter_space = '#header-navigation ul li a, .shortlist-align a{ letter-spacing:'+ to +'px!important;}';
	...
	wp.customize('menu_font_weight', function(  value ){
		value.bind(function(to){
			var menu_font_weight = '#header-navigation ul li a, .shortlist-align a{ font-weight:'+ to +'!important;}';
	...
	wp.customize('child_menu_font_weight', function(  value ){
		value.bind(function(to){
			var child_menu_font_weight = '#header-navigation ul ul li a, .wide_menu strong{ font-weight:'+ to +'!important;}';
...
wp.customize('main_menu_uppercase', function( value ){
	value.bind( function(to){
		if( to == '1' ){
			$('.menu > ul > li > a, .shortlist-align a').css('text-transform', 'uppercase');
		}else{
			$('.menu > ul > li > a, .shortlist-align a').css('text-transform', 'inherit');
		}
	});
});
